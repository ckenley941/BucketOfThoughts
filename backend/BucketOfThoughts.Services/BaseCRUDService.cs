...
public interface ICrudService<TEntity, TModel> where TEntity : BaseDbTable where TModel : BaseDto
{
...
public abstract class BaseCRUDService<TEntity, TModel>(BucketOfThoughtsDbContext dbContext, IMapper mapper, IDistributedCache cache) : ICrudService<TEntity, TModel> where TEntity : BaseDbTable where TModel : BaseDto
{
